...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/12/19 18:15:40 by tdumitra          #+#    #+#              #
#    Updated: 2017/12/20 10:00:36 by tdumitra         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./ft_memset.c ./ft_bzero.c ./ft_memcpy.c ./ft_memccpy.c ./ft_memmove.c ./ft_memchr.c ./ft_memcmp.c \
	  ...
	  ./ft_isprint.c ./ft_toupper.c ./ft_tolower.c  ./ft_digitno.c \
	  ...
	  ./ft_sqrt.c ./ft_strrev.c ./ft_swap.c ./ft_is_prime.c ./ft_recursive_power.c

COMP = ./ft_memset.o ./ft_bzero.o ./ft_memcpy.o ./ft_memccpy.o ./ft_memmove.o ./ft_memchr.o ./ft_memcmp.o \
	   ...
	   ./ft_strcmp.o ./ft_strncmp.o ./ft_atoi.o ./ft_isalpha.o ./ft_isdigit.o ./ft_isalnum.o ./ft_isascii.o \
	   ./ft_isprint.o ./ft_toupper.o ./ft_tolower.o ./ft_digitno.o \
	   ...
	   ./ft_lstnew.o ./ft_lstdelone.o ./ft_lstdel.o ./ft_lstadd.o ./ft_lstiter.o ./ft_lstmap.o \
		./ft_sqrt.o ./ft_strrev.o ./ft_swap.o ./ft_is_prime.o ./ft_recursive_power.o
